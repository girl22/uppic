...
<meta name="description" content="本站为大家免费提供单个文件最大2M的FLASH上传的PHP程序" />
...
<noscript></head></noscript><noscript></noscript>
<noscript><body></noscript><noscript></noscript>
	...
	<div id="cmain">
		<div id="uploadform">
			<form id="form1" action="#" method="post" enctype="multipart/form-data">
				<div>
					<a href="upload/image/kantu.php" target="_blank"><img src="images/logo.png" style="height:60px;width:320px;border:none;" alt="看图"/></a>
				</div>
				<div class="button">
...
------------------------------------<span style="color: #0000FF">以下是论坛专用的贴图代码全部复制发贴的时候粘贴上去即可</span>------------------------------------
		<div id="cmainbottom"><div id="imglist"></div></div>
	</div>
</div>
<div style="display: none;"><textarea></body></html></textarea></div>
